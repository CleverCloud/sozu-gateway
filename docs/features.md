...
| Gateway API | HTTPRoute collision precedence | ✅ | oldest creation timestamp, then alphabetical `namespace/name`, then first matching rule. Backend names do not choose between HTTPRoutes |
